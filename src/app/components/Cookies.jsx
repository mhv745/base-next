    ...
    return !aceptadas ? (
        <div
            ...
            <div className="m-0 p-0">
                <p className="text-xs">
                    {data.siteName} utiliza cookies para mejorar el servicio y analizar el tráfico
                    web
                </p>
        ...
        <div aria-hidden className="fixed bottom-1 right-1">
            <button aria-label="Eliminar cookies instaladas" className="block" onClick={cancelar}>
                <CookieIcon />
            </button>
        </div>
    )
